import { Sparkles, Scissors, Hand, Heart, Flower2 } from "lucide-react";
...
const ServicesSection = () => {
  return (
    <section id="servicios" className="py-24 md:py-32 bg-pearl">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border max-w-5xl mx-auto">
          {services.map((service, index) => (
            <div
              key={service.title}
              className={`bg-background p-10 md:p-12 group hover:bg-primary transition-colors duration-500 ${
            ...
            >
              <service.icon
                strokeWidth={1}
                size={32}
                className="text-primary group-hover:text-primary-foreground transition-colors duration-500 mb-6"
              />
